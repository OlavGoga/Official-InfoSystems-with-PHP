...
if(isset($_POST['Update'])){
    ...
    $sql = "UPDATE phphackero SET Uname = '$Uname', Email = '$Email',Password = '$Password',Phone = '$Phone' WHERE id = '$id'";
    $request = mysqli_query($con,$sql);
    if($request){
...
<div>
    <p>&nbsp</p><a href="SaveGame.php" style="position: relative; text: align-center;">BACK</a>
</div>   
</body>
</html>